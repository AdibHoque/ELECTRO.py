...
async def slap(ctx, user: discord.User):
	...
	channel = ctx.message.channel
	await bot.say('{} was slapped by {}!                               https://cdn.discordapp.com/attachments/508674404788600832/527068926363041792/slap-SkSCyl5yz.gif'.format(user, author))
	if user is None:
		await bot.say('You need to mention a user!')
...
async def kiss(ctx, user: discord.User):
	author = ctx.message.author
	channel = ctx.message.channel
	await bot.say('{} was kissed by {}!             https://cdn.discordapp.com/attachments/508674404788600832/527071848710537226/kiss-ByTBhp_vZ.gif'.format(user, author))
	if user is None:
		await bot.say('You need to mention a user!')
...
async def bite(ctx, user: discord.User):
	author = ctx.message.author
	channel = ctx.message.channel
	await bot.say('{} was bitten by {}                                  https://cdn.discordapp.com/attachments/508674404788600832/527073669600641039/bite-HJmbWxmiZ.gif'.format(user, author))
	if user is None:
		await bot.say('You need to mention a user!')
