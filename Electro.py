...
async def status_task():
    while True:
        ...
        await asyncio.sleep(5)
        await bot.change_presence(ame=discord.Game(name='in '+str(len(bot.servers))+' servers'))
        await asyncio.sleep(5)
...
@bot.command()
async def upvote():
	await bot.say('**CLICK THE LINK BELOW AND UPVOTE ME-** https://discordbots.org/bot/510491243155816449')	
