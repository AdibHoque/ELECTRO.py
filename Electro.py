...
helpm.add_field(name = '<:ElectroGeneralBadge:680783367247364097> GENERAL COMMANDS - (17)',value ='`ping`,`userinfo`,`serverinfo`,`ownerinfo`,`avatar`,`membercount`,`math`,`invite`,`upvote`,`pokemon`,`shinypokemon`,`pokefuse`,`8ball`,`electroav`,`brilliance`,`bravery`,`balance`',inline = False)
...
helpm.add_field(name = '<:ElectroFunBadge:680783413065941002> FUN COMMANDS - (20)',value ='`triggered`,`brazzers`,`burn`,`gay`,`missionpassed`,`thanos`,`rip,`meme`,`pat`,`love`,`slap`, `kiss`, `hug`, `cuddle`, `spank`, `tweet`, `rolldice`, `flipcoin`, `howgay`, `whowouldwin`, `captcha`,`magik`,`deepfry`,`iphonex`,`threats`,`clyde`,`trash`',inline = False)
...
helpm.add_field(name = '<:ElectroNSFWBadge:680783452563439774> NSFW COMMANDS - (26)',value ='`boobs`,`pussy`,`ass`,`thighs`,`porngif`,`4k`,`anal`,`classic`,`blowjob`,`hentai`,`hentaianal`,`hentaithigh`,`hentaineko`,`hentaikitsune`,`girlsolo`,`pussygif`,`feet`,`femdom`,`pussyart`,`smallboobs`,`girlsologif`,`classic`,`cumsluts`,`randomhentaigif`,`bjgif`,`lesbian`\n\n<:ElectroBookmark:668018207549816833> **ADDITIONAL LINKS:**\n[Add Bot](https://discordapp.com/api/oauth2/authorize?client_id=629323586930212884&permissions=8&scope=bot) | [Join Server](https://discord.gg/kuWVFpR ) | [Upvote](https://discordbots.org/bot/629323586930212884/vote)',inline = False)
...
async def help(ctx, page: str=None):
        if page is None:
            ...
            help3.add_field(name = 'Kiss',value ='Kisses mentioned user!\n**USAGE:**``e!kiss @user``',inline = False)
            ...
            help3.add_field(name = 'Gender',value ='ELECTRO detects gender of mentioned user!\n**USAGE:**``e!gender @user``',inline = False) 
            help3.add_field(name = 'Tweet',value ='Make a fake twitter tweet!\n**USAGE:**``e!tweet [twitter name] [text]``',inline = False) 
            help3.add_field(name = 'Rolldice',value ='ELECTRO rolls dice and sends random number 1-6!\n**USAGE:**``e!rolldice``',inline = False)
            help3.add_field(name = 'Flipcoin',value ='ELECTRO flips coin!\n**USAGE:**``e!flipcoin``',inline = False)
