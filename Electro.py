...
async def status_task():
    while True:
        await bot.change_presence(game=discord.Game(name='e!help • '+str(len(bot.servers))+' Guilds • '+(len(set(bot.get_all_members())))+' Users'))
        await asyncio.sleep(12)
        await bot.change_presence(game=discord.Game(name='e!help • '+str(len(bot.servers))+' Guilds • '+(int(len(set(bot.get_all_members())))+' Users'))
        await asyncio.sleep(12)
