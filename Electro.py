...
async def help(ctx):
    ...
    embed.add_field(name = '<:ElectroGeneral:665597887866208309> General Commands',value ='`ping`,`userinfo`,`serverinfo`,`ownerinfo`,`avatar`,`membercount`,`invite`,`upvote`',inline = False)
    embed.add_field(name = '<:ElectroModeration:665590244724441099> Moderation Commands',value ='`kick`,`ban`,`setnick`,`role`,`say`,`DM`,`english`,`rolecolor`,`lockdown`,`unlock`,`menro`',inline = False)
    embed.add_field(name = '<:ElectroFun:665590182204014592> Fun Commands',value ='`joke`,`love`,`slap`, `kiss`, `hug`, `virgin`, `gender`, `tweet`, `rolldice`, `flipcoin`, `howgay`, `whowouldwin`, `captcha`,`magik`,`deepfry`',inline = False)
    embed.add_field(name = '<:ElectroMusic:665590371035774997> Music Commands',value ='`play`,`pause`,`resume`,`now playing`\n[Add Bot](https://discordapp.com/api/oauth2/authorize?client_id=629323586930212884&permissions=8&scope=bot) | [Join Server](https://discord.gg/kuWVFpR ) | [Upvote](https://discordbots.org/bot/629323586930212884/vote)',inline = False)
