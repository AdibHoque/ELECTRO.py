...
async def help(ctx):
    ...
    embed.add_field(name = '<:ElectroGeneral:665597887866208309> General Commands | PAGE 1',value ='General commands which everyone can use!.',inline = False)
    embed.add_field(name = '<:ElectroModeration:665590244724441099> Moderation Commands | PAGE 2',value ='Commands that are used for moderation and can only be used by server moderators.',inline = False)
    embed.add_field(name = '<:ElectroFun:665590182204014592> Fun Commands | PAGE 3',value ='Fun commands are used for fun and can be used by everyone.',inline = False)
    embed.add_field(name = '<:ElectroMusic:665590371035774997> Music Commands | PAGE 4',value ='Music commands for playing music.\n[Add Bot](https://discordapp.com/api/oauth2/authorize?client_id=629323586930212884&permissions=8&scope=bot) | [Join Server](https://discord.gg/kuWVFpR ) | [Upvote](https://discordbots.org/bot/629323586930212884/vote)',inline = False)
