...
async def stream():
	await bot.change_presence(game=discord.Game(name="A BOT BY ADIB", url="https://twitch.tv/myname", type=1))
	await bot.say('Your bot is now streaming for **A BOT BY ADIB**')
	await bot_message(ctx.message)
